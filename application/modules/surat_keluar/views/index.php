...
<div class="content-page">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="alert alert-warning mb-3" role="alert">
                                <i class="mdi mdi-alert-circle-outline mr-2"></i> Anda dapat melakukan pencarian data surat keluar secara spesifik dengan memilih <strong>sifat surat dan status arsip surat</strong>
                            </div>
                            <div class="row">
                                <div class="col-lg-8">
                            ...
                            <hr>
                            <a href="<?= base_url('surat_keluar/tambah') ?>" class="btn btn-sm btn-warning waves-effect waves-light mb-3">
                                <span class="btn-label"><i class="fe-plus"></i></span>Tambah surat keluar
                            </a>

                            <div class="table-responsive">
                                <table class="table table-striped nowrap w-100" id="table-surat-keluar">
                                    <thead>
                                        <tr>
                                            <th class="text-center">Aksi</th>
                                            <th class="text-center">Nomor / Kode</th>
                                            <th class="text-center">Isi / File Surat</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Verifikasi Surat Keluar</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body p-4">

                    <div class="alert alert-info" role="alert">
                        Pastikan anda telah memeriksa kelengkapan surat masuk atau konsep surat yang telah dibuat!.
                    </div>

                    <input type="hidden" name="id_skeluar" id="id_skeluar">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="catatan_kelengkapan" id="catatan_kelengkapan" cols="30" rows="10" class="form-control" placeholder="Tulis sesuatu..."></textarea>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-success waves-effect waves-light verifikasi">
                        <span class="btn-label"><i class="fe-save"></i></span>Verifikasi
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table-surat-keluar').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('surat_keluar/load_data') ?>",
                    "type": "POST",
                    "data": function(data) {
