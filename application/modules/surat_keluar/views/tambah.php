                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="tujuan_surat" id="tujuan_surat" class="form-control" placeholder="Tulis dari mana surat berasal">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="bidang" id="bidang" class="form-control" placeholder="Input nama bidang">
                                        <small class="text-danger"><?= form_error('bidang') ?></small>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="pembuat_surat">Pembuat Surat <span class="text-danger">*</span></label>
                                        <input type="text" name="pembuat_surat" id="pembuat_surat" class="form-control" placeholder="Tulis nama pembuat surat">
