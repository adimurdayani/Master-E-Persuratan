...
class M_jenissurat extends CI_Model
{

    var $table = 'tb_jenis_surat';
    var $column_order   = array(null, 'kode', 'jenis_surat'); //field yang ada di table user
    var $column_search  = array('kode', 'jenis_surat'); //field yang diizin untuk pencarian 
