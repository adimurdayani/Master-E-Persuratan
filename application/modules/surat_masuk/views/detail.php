        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-footer">
                            <h4 class="header-title"> <i class="fe-check text-success"></i> Disposisi Surat Masuk</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-striped w-100">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?= $get_disposisi['tujuan_disposisi'] ?></td>
                                        <td><?= $get_disposisi['isi_disposisi'] ?></td>
                                        <td><?= $get_disposisi['sifat_disposisi'] ?></td>
                                        <td><?= $get_disposisi['batas_waktu'] ?></td>
                                        <td><?= $get_disposisi['tgl_selesai'] ?></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="badge badge-success">
                                <i class="fe-file"></i> File PDF / Gambar
                            </div>
                            <br>
                            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0" class="scrollspy-example">
                                <img src="<?= base_url('assets/backend/images/surat_masuk/') . $get_surat['file_surat'] ?>" alt="file surat disposisi" class="img-thumbnail mt-2" width="100%">
                            </div>
                        </div> <!-- end card body-->
                    </div> <!-- end card -->
                </div><!-- end col-->
