                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="asal_surat" id="asal_surat" class="form-control" placeholder="Tulis dari mana surat berasal" value="<?= $get_surat['asal_surat'] ?>">
                                        <small class="text-danger"><?= form_error('asal_surat') ?></small>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="no_surat">No. Surat <span class="text-danger">*</span></label>
                                        <input type="number" name="no_surat" id="no_surat" class="form-control" placeholder="Tulis dengan teliti nomor surat masuk" value="<?= $get_surat['no_surat'] ?>">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="jenis_surat" id="jenis_surat" class="form-control" placeholder="Contoh: Surat izin, SPPD, Surat Pengantar" value="<?= $get_surat['jenis_surat'] ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="penerima" id="penerima" class="form-control" placeholder="Tulis nama penerima surat" value="<?= $get_surat['penerima'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="text-danger">Hanya file .JPG, .JPEG, .PNG dan PDF</small>
                                    </div>
