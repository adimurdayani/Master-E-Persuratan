                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-lg-right mt-3 mt-lg-0">
                                        <button type="submit" class="btn btn-warning waves-effect waves-light"><i class="fe-printer mr-1"></i> Cetak</button>
                                    </div>
                                </div><!-- end col-->
                            </div> <!-- end row -->
                            <?= form_close() ?>
