...
class Rekap_surat_keluar extends CI_Controller
{
    ...
    public function cetak()
    {
        if (!$this->ion_auth->logged_in()) {
            ...
            $data['title'] = 'Rekapitulasi Laporan Surat Keluar';
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect('rekap_surat_keluar');
            } else {
                $data['get_surat'] = $this->m_rskeluar->get_data()->result_array();
                // var_dump($data['get_surat']);
                // die;
                $this->load->view('cetak-surat-keluar', $data, FALSE);
            }
        }
    }
}
