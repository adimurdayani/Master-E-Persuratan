...
class Bidang extends CI_Controller
{
            ...
            foreach ($list as $field) {
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a href="javascript: void(0);" data-id="' . base64_encode($field->id) . '" class="dropdown-item edit-bidang" title="Edit data"><i class="fe-edit"></i> Edit data</a>
    ...
    {
        $penerima = $this->m_bidang->get_data()->row_array();
