                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="alert alert-info mb-3" role="alert">
                                <i class="mdi mdi-alert-circle-outline mr-2"></i> Data bidang digunakan untuk menentukan bidang yang ada di suatu instansi. <strong>Data ini dapat mempermudah dalam menentukan sub bidang yang ada di suatu instansi, pada saat akan menambahkan surat masuk dan surat keluar</strong>.
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped nowrap w-100" id="table-bidang">
                                    <thead>
                                        <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table-bidang').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('bidang/load_data') ?>",
                    "type": "POST",
                    "data": function(d) {
            ...
            //update data
            $(document).on('click', '.edit-bidang[data-id]', function() {
                var id = $(this).data('id');
                $('#edit').modal('show');
                $.ajax({
                    url: "<?= base_url(); ?>bidang/show_data",
                    method: 'POST',
                    cache: false,
                    dataType: "JSON",
                    data: {
