                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tujuan_disposisi" id="penerima" class="form-control" placeholder="Input tujuan disposisi" autofocus>
                                        <small class="text-danger"><?= form_error('tujuan_disposisi') ?></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="isi_disposisi">Isi Disposisi</label>
                                        <textarea name="isi_disposisi" id="isi_disposisi" rows="5" class="form-control" placeholder="Input isi disposisi"></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-success float-right"><i class="fe-save"></i> Simpan</button>
                                </div>
                            </div>
                            <?= form_close() ?>
